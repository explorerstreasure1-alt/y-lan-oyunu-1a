...
export function ArcadeControls({ onDirectionChange, onPauseToggle, isPlaying, isBoosting, onBoostStart, onBoostEnd, onPoisonFire, poisonAmmo }: ArcadeControlsProps) {
  return (
    <div className="relative mt-1 flex w-full shrink-0 flex-col items-center gap-1.5 sm:hidden select-none">
      {/* Premium D-pad — eski yerinde, ortalı (yerleşim değişmedi) */}
      ...
      {/* ☠️ Zehir — sağdaki boş alanda YÜZER, pedin yerini kaydırmaz (alan kaplamaz) */}
      <button
        type="button"
